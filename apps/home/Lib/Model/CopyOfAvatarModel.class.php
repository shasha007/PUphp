...
class AvatarModel extends Model{
    ...
    function upload(){
        ...
        $pic_abs_path = PIC_URL.'/data/uploads/avatar/'.$this->uid.'/original.jpg';
        //保存上传图片.
    ...
    //    $avtar_img = imagecreatefromjpeg(SD_ROOT.'./'.$new_avatar_path);
      //  imagejpeg($avtar_img,SD_ROOT.'./'.$new_avatar_path,80);
        ...
        $d->data->urls[0] = PIC_URL.'/data/uploads/avatar/'.$this->uid.'/'.$new_avatar_path;
        $d->status = 1;
    ...
    function getcamera(){
       ...
       // imagejpeg($avtar_img,$new_avatar_path,80);
        ...
        //$d->data->urls[0] = 'http://sns.com/avatar_test/'.$new_avatar_path;
        $d->data->urls[0] = PIC_URL.'/data/uploads/avatar/'.$this->uid.'/original.jpg';
        $d->status = 1;
        $d->statusText = L('upload_success');
