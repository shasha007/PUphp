 ...
 */
class EventGroupWeiboWidget extends Widget {
	...
	public function render($data) {
		...
		$data['url']	= U('event/GroupWeiboOperate/weibo',array('button_title'=>urlencode($data['button_title']),'tpl_name'=>$data['tpl_name']));
		
		$content = $this->renderFile("EventGroupWeibo", $data);
		return $content;
	}
}