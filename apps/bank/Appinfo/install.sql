CREATE TABLE `bank_card` (
  ...
  `parents_mobile` varchar(20) NOT NULL COMMENT '学生家长手机号',
...
CREATE TABLE `bank_applycard_order` (
...
CREATE TABLE `bank_applycard_order_card` (
...
CREATE TABLE `bank_applycard_order_log` (
  `id` int(11) unsigned NOT NULL auto_increment,
...
CREATE TABLE `bank_lend_order_log` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `order_id` bigint(20) NOT NULL,
  `post_data` text NOT NULL COMMENT '发送数据',
  `rev_data` text DEFAULT '' COMMENT '接收数据',
...
CREATE TABLE `bank_deduct_order` (
  `order_id` bigint(20) unsigned NOT NULL auto_increment,
  `uid` int(11) NOT NULL COMMENT '学生uid',
...
CREATE TABLE `bank_deduct_order_log` (
  `id` int(11) unsigned NOT NULL auto_increment,
  `order_id` bigint(20) NOT NULL,
  `post_data` text NOT NULL COMMENT '发送数据',
  `rev_data` text DEFAULT '' COMMENT '接收数据',
...
CREATE TABLE `bank_finance_detail` (
  `id` bigint(20) unsigned NOT NULL auto_increment,
