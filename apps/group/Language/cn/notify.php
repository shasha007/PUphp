...
return array(
	...
	'group_join' => array(
		'title' => '{actor} 请求加入 “' . $title . '” 社团',
		'other' => '<a href="' . U('even/GroupManage/memberManage',array('gid'=>$gid, 'type'=>'apply')).'" target="_blank">去看看</a>',
	),
	'group_invite' => array(
		'title' => '{actor} 诚邀加入 “' . $title . '” 社团',
		'other' => '<a href="' . U('event/GroupTopic/index',array('gid'=>$gid)).'" target="_blank">去看看</a>',
	),
);