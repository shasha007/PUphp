...
class GroupWeiboModel extends Model{
    ...
    function getOneApi($id,$info,$uid=0){
    		...
    		if( $info['type']==1 && $info['transpond_id']==0 ){
    			...
    			$info['type_data']['picurl'] = PIC_URL.'/data/uploads/'.$info['type_data']['picurl'];
    			$info['type_data']['thumbmiddleurl'] = PIC_URL.'/data/uploads/'.$info['type_data']['thumbmiddleurl'];
    			$info['type_data']['thumburl'] = PIC_URL.'/data/uploads/'.$info['type_data']['thumburl'];
    		}
