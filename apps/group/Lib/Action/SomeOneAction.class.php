...
class SomeOneAction extends BaseAction {
	...
	public function _initialize() {
    	...
    	// 社团热门排行
    	$hot_group_list = D('Group')->getHotListMin();
	...
	public function index()
	{
		...
		switch ($type) {
			case 'join': // 我管理的
        		...
        		$this->setTitle("我加入的社团");
				break;
			case 'manage': // 我加入的
				$group_list = D('Group')->mymanagegroup($this->uid, 1);
        		$this->setTitle("我管理的社团");
				break;
			case 'following': // 我关注的人的
				$db_prefix  = C('DB_PREFIX');
				$group_list = D('Group')->field('g.id,g.name,g.type,g.membercount,g.logo,g.cid0,g.ctime,g.status,g.vStern')
